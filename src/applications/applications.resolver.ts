...
export class ApplicationsResolver {
    ...
    async createApplication(@Args('application') createApplicationInput: CreateApplicationDto) {
        return this.applicationsService.create(createApplicationInput);
    }

    @Mutation(() => Application)
    async updateApplication(@Args('id') id: number, @Args('application') updateApplicationInput: UpdateApplicationInput) {

...
export class PushNotificationDto extends Base {
  ...
  @ApiProperty({
    type: String,
    required: false,
    description: 'push notification subtitle',
    example: 'default',
  })
  subtitle?: string;
  ...
  @ApiProperty({
    type: String,
    required: false,
    description: 'push notification sender name',
    example: 'Jobs Portal',
  })
  name?: string;
  ...
  @ApiProperty({
    type: String,
    required: false,
    description: 'push notification attachment',
  ...
  @ApiProperty({
    type: String,
    required: false,
    description: 'push notification badge',
    example: '1',
  })
  badge?: string;
  ...
  @ApiProperty({
    type: String,
    required: false,
    description: 'push notification sound',
    example: 'default',
  })
  sound?: string;
  ...
  @ApiProperty({
    type: String,
    required: false,
    description: 'push notification thread identifier',
    example: 'default',
  })
  threadId?: string;
